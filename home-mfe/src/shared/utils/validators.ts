import { CampaignFormData, ContactFormData, ValidationResult } from "../types";
...
const validateContactForm = (data: Partial<ContactFormData>): ValidationResult => {
    ...
    /**
         * Froneus Challenge Notation to Jorge Repossi
         * 
         * @param { string } data.lasrName -  The last name is required and must be at least 4 characters long.
         * @abstract The last name must contain only letters
         * @returns { ValidationResult } - The result of the validation
         * @example
         * // Valid LastName
         * const data = { lasttName: "Doe", "O'Connor" };
         * 
     */
    ...
    /**
         ...
         * @abstract The phone must contain only numbers and be between 8 and 15 digit
         * @returns { ValidationResult } - The result of the validation
         * @example
         * // Valid Phone
...
/**
     ...
     * @param {boolean} data.recordCalls - Record calls flag (required)
...
const validateCampaignForm = (data: Partial<CampaignFormData>) => {
    const errors: Record<string, string> = {};
